            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 mb-sm-30">
                    <div class="single-banner zoom">
                        <img src="{{ asset('assets/onsite/foam.png') }}" alt="banner-img">
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-4 mb-sm-30">
                    <div class="single-banner zoom">
                        <img src="{{ asset('assets/onsite/sunscreen.png') }}" alt="banner-img">
                    </div>
                </div>
                <!--  Single Banner Area End -->
                <!--  Single Banner Area Start -->
                <div class="col-lg-4 col-md-4">
                    <div class="single-banner zoom">
                            <img src="{{ asset('assets/onsite/serum.png') }}"
                                alt="banner-img">
                        </a>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <div class="sec-title">
                        <p>About 24PLUS</p>
                        <div class="title">We Are <br>24 Plus<span> Product by Tvpool</span></div>
                    </div>
                </div>
                <div class="col-xl-7">
                    <div class="about-style2-text">
                        <div class="text">
                            <h1 style="color: #2f9d9a;" >มิติใหม่เพื่อผิวสวย</h1>
                            <p style="font-size: 20px;">
                                การคิดค้นเวชสำอางโดยแพทย์ผู้เชี่ยวชาญมีความสำคัญในการพัฒนาผลิตภัณฑ์ที่ปลอดภัยและมีประสิทธิภาพสำหรับผู้บริโภค
                                โดยเฉพาะในกรณีที่ผลิตภัณฑ์มีส่วนผสมทางการแพทย์หรือมีผลกระทบต่อสุขภาพของผู้ใช้งาน
                                การคิดค้นเวชสำอางโดยแพทย์ผู้เชี่ยวชาญจะรวมการวิจัยทางการแพทย์และความเข้าใจในวิทยาศาสตร์ของผิวพรรณและระบบการทำงานของผิวพรรณเข้าด้วยกันเพื่อสร้างผลิตภัณฑ์ที่มีประสิทธิภาพในการดูแลและปรับปรุงสุขภาพของผิวพรรณของผู้ใช้.
                            </p>
                        </div>
                        <!--
